    ...
    return (
      <div className="App">
        ...
        <div className="wrapper">
          <Car title="Dojezd na jedno nabití" />
          <Stats state={this.state} speed={this.state.speed} temperature={this.state.temperature} heat={this.state.heating} heatOn={this.state.heatingOn} />
